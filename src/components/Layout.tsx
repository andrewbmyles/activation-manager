...
import { Users, Monitor, Share2, BarChart3, Home, ChevronDown, Settings, HelpCircle, Target, Save } from 'lucide-react';
...
export function Layout() {
  ...
  const navItems = [
    ...
    { id: 'saved-audiences', label: 'Saved Audiences', icon: Save, path: '/saved-audiences' },
