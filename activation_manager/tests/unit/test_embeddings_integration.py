...
class TestEnhancedVariableSelectorV3(unittest.TestCase):
    """Test the enhanced variable selector with embeddings"""
    
    @patch('activation_manager.core.enhanced_variable_selector_v3.EmbeddingsHandler')
    def test_embeddings_initialization(self, mock_handler):
        ...
        with patch('activation_manager.core.enhanced_variable_selector_v3.EMBEDDINGS_AVAILABLE', True):
            with patch('activation_manager.core.enhanced_variable_selector_v3.LOADER_AVAILABLE', True):
                with patch('activation_manager.core.enhanced_variable_selector_v3.EmbeddingsLoader') as mock_loader:
    ...
    def test_fallback_to_tfidf(self):
        ...
        with patch('activation_manager.core.enhanced_variable_selector_v3.EMBEDDINGS_AVAILABLE', False):
            selector = EnhancedVariableSelectorV3(use_embeddings=True)
