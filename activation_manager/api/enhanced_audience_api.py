...
try:
    variable_selector = VariableSelector(openai_api_key=os.getenv('OPENAI_API_KEY'))
    print("✅ Using Variable Selector with embeddings support")
except Exception as e:
    print(f"⚠️  Failed to initialize Variable Selector: {e}")
