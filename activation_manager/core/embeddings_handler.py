...
class EmbeddingsHandler:
    ...
    def get_query_embedding(self, query: str, openai_client=None) -> Optional[np.ndarray]:
        """
        Get embedding for a query string using OpenAI API.
        ...
        if not openai_client:
            logger.warning("No OpenAI client provided for query embedding")
            return None
